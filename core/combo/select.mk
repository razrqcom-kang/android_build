...
ifeq ($(USE_MORE_OPT_FLAGS),yes)
    $(combo_target)RELEASE_CFLAGS := -O3 -fno-tree-vectorize -fno-inline-functions -g -Wstrict-aliasing=3 -Werror=strict-aliasing
else
    $(combo_target)RELEASE_CFLAGS := -O2 -g -Wstrict-aliasing=3 -Werror=strict-aliasing
endif
